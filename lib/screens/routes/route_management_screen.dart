...
class _RouteManagementScreenState extends State<RouteManagementScreen> {
  ...
  Future<void> _startTrip(DriverDailyTrip trip) async {
    final confirm = await showDialog<bool>(
      ...
      builder: (ctx) => AlertDialog(
        ...
        title: Text('Start Route?', style: GoogleFonts.outfit(fontWeight: FontWeight.w500)),
        content: Text(
          'Start the "${trip.routeLabel}" route?\n\nParents will be notified immediately.',
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: Text("Today's Routes", style: GoogleFonts.outfit(fontWeight: FontWeight.w500, color: AppColors.textPrimary, fontSize: 18)),
        actions: [
          IconButton(
            icon: Container(
              width: 34, height: 34,
          ...
          Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                Row(
                  children: [
                    _Stat(icon: Icons.schedule_rounded, label: 'Time', value: trip.scheduledTime),
                    if (trip.isActive || trip.isCompleted) ...[
                      const SizedBox(width: 8),
                      _Stat(icon: Icons.people_rounded, label: 'Students', value: '${trip.studentCount}'),
                      const SizedBox(width: 8),
                      _Stat(
      ...
      return Container(
        ...
        child: Row(
          ...
          children: [
            ...
            const SizedBox(width: 8),
            Text('Completed', style: GoogleFonts.outfit(color: AppColors.success, fontWeight: FontWeight.w500, fontSize: 14)),
          ],
        ),
      );
    }
        ...
        child: Container(
          ...
          child: Row(
            ...
            children: [
              ...
              const SizedBox(width: 8),
              Text('Resume Route', style: GoogleFonts.outfit(color: Colors.white, fontWeight: FontWeight.w500, fontSize: 14)),
            ],
          ),
        ),
      );
        ...
        child: Container(
          ...
          child: Row(
            ...
            children: [
              ...
              const SizedBox(width: 8),
              Text('Start Route', style: GoogleFonts.outfit(color: Colors.white, fontWeight: FontWeight.w500, fontSize: 14)),
            ],
          ),
        ),
      );
        ...
        children: [
          ...
          GestureDetector(
            ...
            child: Container(
              ...
              child: Text('Try Again', style: GoogleFonts.outfit(color: Colors.white, fontWeight: FontWeight.w500)),
            ),
          ),
        ],
      ),
            ...
            child: Container(
              ...
              child: Row(
                ...
                children: [
                  ...
                  Text('Refresh', style: GoogleFonts.outfit(color: AppColors.primary, fontWeight: FontWeight.w400)),
                ],
              ),
            ),
          ),
